...
public class BinarySearchTree < E extends Comparable < E >>
   ...
   */
  public boolean add(E item,E vsl) {
    root = add(root, item,vsl);
    return addReturn;
  }
  ...
  /** Recursive add method.
      ...
      @return The new local root that now contains the
              inserted item
   */
  private Node < E > add(Node < E > localRoot, E item, E val) {
    if (localRoot == null) {
      // item is not in the tree � insert it.
      addReturn = true;
      return new Node < E > (item,val);
    }
      ...
      localRoot.left = add(localRoot.left, item, val);
      return localRoot;
    }
    else {
      // item is greater than localRoot.data
      localRoot.right = add(localRoot.right, item, val);
      return localRoot;
    }
  }
  ...
  private E findLargestChild(Node < E > parent) {
    ...
    if (parent.right.right == null) {
      E returnValue = parent.right.key;
